...
export class UserController {
    ...
    async changePassword(
        ...
        try {
            ...
            await this.userService.changePassword({ id, oldPassword: body.oldPassword, password: body.password });
    ...
    async changeEmail(
        ...
        try{
            ...
            await this.userService.changeEmail({id: id,password: body.password,email: body.newEmail});
